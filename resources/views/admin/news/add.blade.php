          ...
          <form role="form"  action="{{route('admin.news.add')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Please Enter News Image Caption" name="image_caption" value="{{ old('image_caption') }}">
                </div>
            </div>
            <div class="card-body">
                <div class="form-group">
            ...
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Please Enter News Autor Name" name="autor" value="{{ old('autor') }}">
                </div>
            </div>
            <div class="card-body">
                <div class="form-group">
