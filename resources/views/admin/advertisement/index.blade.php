...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
        ...
        <a href="{{route('admin.advertisement.add')}}" class="btn btn-primary">Add Advertisement</a>
            ...
            @php($count++)
                <tr>
                  ...
                  <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="{{route('admin.advertisement.edit',$item->id)}}">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                      </a>
                      <a onclick="onClickDelete(event)" class="btn btn-danger btn-sm" href="{{route('admin.advertisement.delete',$item->id)}}">
